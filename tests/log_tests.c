...
static bool test_info_log() {
  color_log(LOG_COLOR_CYAN, "test_info_log\n");
...
static bool test_debug_log() {
  color_log(LOG_COLOR_CYAN, "test_debug_log\n");
...
static bool test_error_log() {
  color_log(LOG_COLOR_CYAN, "test_error_log\n");
...
static bool test_color_log() {
  color_log(LOG_COLOR_CYAN, "test_color_log\n");
...
static bool test_color_log_with_format() {
  color_log(LOG_COLOR_CYAN, "test_color_log_with_format\n");
