 ...
 * @param[in] ... Options for the string.
 */
#define info_detailed(str, ...)                                                \
  info_log("file:%s func:%s line:%d -- " str, __FILE__, __func__, __LINE__,    \
           __VA_ARGS__);
/**
 ...
 * @param[in] ... Options for the string.
 */
#define debug_detailed(str, ...)                                               \
  debug_log("file:%s func:%s line:%d -- " str, __FILE__, __func__, __LINE__,   \
            __VA_ARGS__);
/**
 ...
 * @param[in] ... Options for the string.
 */
#define error_detailed(str, ...)                                               \
  error_log("file:%s func:%s line:%d -- " str, __FILE__, __func__, __LINE__,   \
            __VA_ARGS__);
